...
>>>>>>> d161660e15d0be038af15bca301ef9e41e023a3c:lib/python/flame/examples/medmnist/trainer/main.py
    ...
    def load_data(self) -> None:
        ...
        The dataset is kindly released by Jakob Nikolas Kather, Johannes
        Krisam, et al. (2019) in their paper "Predicting survival from
        colorectal cancer histology slides using deep learning: A
        retrospective multicenter study", and made available through Yang et
        al. (2021) in "MedMNIST Classification Decathlon: A Lightweight AutoML
        ...
        train_dataset = PathMNISTDataset(
            split="train", transform=data_transform
        )
    ...
    def train(self) -> None:
        ...
        for epoch in range(self.epochs):
            ...
            for data, label in self.train_loader:
                ...
                # Squeeze because of multi-class classification instead of
        ...
        with torch.no_grad():
            for data, label in self.val_loader:
                ...
                labels_pred = torch.cat(
                    [labels_pred, output.argmax(dim=1)], dim=0
                )
